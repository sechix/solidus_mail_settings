  ...
  module Core
    class MailSettings
      ...
      def self.init
        ...
        ActionMailer::Base.default_url_options[:host] ||= Spree::Store.default if Spree::Store.table_exists?
      end
      ...
      def user_credentials
        {
          user_name: Spree::Rentals::Config.smtp_username,
          password: Spree::Rentals::Config.smtp_password
        }
      end

      def basic_settings
        {
          address: Spree::Rentals::Config.mail_host,
          domain: Spree::Rentals::Config.mail_domain,
          port: Spree::Rentals::Config.mail_port,
          authentication: Spree::Rentals::Config.mail_auth_type
        }
      end

      def need_authentication?
        Spree::Rentals::Config.mail_auth_type != 'None'
      end

      def secure_connection?
        Spree::Rentals::Config.secure_connection_type == 'TLS'
      end
    end
  end
end
